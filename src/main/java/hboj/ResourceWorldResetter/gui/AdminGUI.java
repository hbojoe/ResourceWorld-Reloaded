package hboj.ResourceWorldResetter.gui;

import hboj.ResourceWorldResetter.ResourceWorldResetter;
...
public class AdminGUI implements Listener {
    ...
    public void openWorldSelectionMenu(Player player) {
        ...
        Set<String> worldNames = plugin.getAvailableWorldNames();
        for (String worldName : worldNames) {
            ...
            if (world != null) {
                ...
                icon = Material.MAP;
                description = "World is currently unloaded";
            }
